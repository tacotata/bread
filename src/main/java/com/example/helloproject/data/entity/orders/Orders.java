...
public class Orders extends BaseEntity {
    ...
    @Builder
    public Orders(Long id, Users users, OrderStatus orderStatus, String reservedDate, String reservedTime, Long storeId, List<OrderItem> orderItems) {
        this.id = id;
        this.users = users;
    ...
    public static Orders createOrders(Users users, List<OrderItem> orderItemList, Cart cart) {
        ...
        orders.setStoreId(cart.getStore().getId());
